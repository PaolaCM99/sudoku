...
import com.example.sudoku.MainMenuActivity
...
class LevelOneActivity : AppCompatActivity(){
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        val sounds = arrayOf(
            MediaPlayer.create(this, R.raw.click1),
            MediaPlayer.create(this, R.raw.click2),
        )
        ...
        val home = findViewById<Button>(R.id.mainMenu).setOnClickListener {
            val intent = Intent(this@LevelOneActivity, MainMenuActivity::class.java)
                            ...
                            if (button != null && button.text.toString() != correctNumber.toString()) {
                                ...
                                val originalBorder =
                                    if ((rowIndex * mainGridLayout.columnCount + colIndex) % 2 == 0) {
                                        R.drawable.purpleborder
                                    } else {
                                        R.drawable.bluebabyborder
                                    }
